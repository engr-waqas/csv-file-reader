...
public class FileReader {
                ...
                if (fileType.equals("json")) {
                    ...
                    while (fileInput.hasNextLine()) {
                        ...
                        for(String jsonValue : jsonValues) {
                            ...
                            System.out.println("+" + keyValue[0].trim()+"+"+ keyValue.length);
    ...
    public static void writeInYamlFile(HashMap<String, HashMap<String, String>> data) {
        try {
            FileWriter fileWriter = new FileWriter("yamlfile.yml");
            ...
            System.out.println("Data written to yamlfile.yml");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    public static void writeInJsonFile(HashMap<String, HashMap<String, String>> data) {
        try {
